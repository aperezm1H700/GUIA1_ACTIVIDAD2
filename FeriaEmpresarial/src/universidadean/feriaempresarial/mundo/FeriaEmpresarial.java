...
public class FeriaEmpresarial {
    ...
    private int cantidadExpositores(int numPuesto, String zona){
        Puesto p = null;
        for (Puesto puesto :puestos){
    ...
    public String metodo1() {
        int sumOccidente=0;
        for(int a=1;a<=3;a++){
            sumOccidente = sumOccidente + cantidadExpositores(a,"Zona occidente");
        }

        int sumNorte = 0;
        for (int a=1;a<=4;a++){
            sumNorte = sumNorte + cantidadExpositores(a,"Zona norte");
        }

        int sumCentro=0;
        for(int a=1;a<=8;a++){
            sumCentro=sumCentro+cantidadExpositores(a,"Zona centro");
        }

        int sumOriente=0;
        for(int a=1;a<=3;a++){
            sumOriente=sumOriente+cantidadExpositores(a,"Zona oriente");
        }

        int sumSur=0;
        for(int a=1;a<=4;a++){
            sumSur=sumSur+cantidadExpositores(a,"Zona sur");
        }

        int puestos1[]=new int[5];

        puestos1[0] = sumOccidente;
        puestos1[1] = sumNorte;
        puestos1[2] = sumCentro;
        puestos1[3] = sumOriente;
        puestos1[4] = sumSur;

        int mayor=0;
        String zonaMayor="Ninguna";
        ...
        for(int i=0;i<=4;i++){
            if(puestos1[i]>mayor){
                ...
                switch (i){
                    case 0:
                        zonaMayor="Zona Occidente";
                    break;
                    case 1:
                        zonaMayor="Zona norte";
                    break;
                    case 2:
                        zonaMayor="Zona centro";
                    break;
                    case 3:
                        zonaMayor="Zona oriente";
                    break;
                    case 4:
                        zonaMayor="Zona sur";
                    break;
        ...
        return "Zona con mayor número de expositores: "+zonaMayor.toUpperCase();
    }
    ...
    public String metodo2() {
        ...
        int totalPersonasExpositoras = 237;
        int totalExpositoresActual = sumCentro+sumSur+sumNorte+sumOriente+sumOccidente;

        double porcentajeExpositores = (totalExpositoresActual*100)/totalPersonasExpositoras;

        /**Saber el porcentaje de equilibro o ocupacion que lleva la feria con los
         * expositores*/
        String porcentaje = String.valueOf(porcentajeExpositores);

        if (porcentajeExpositores>=60){

            return "El punto de equilibrio se ha cumplido: "+porcentaje+"%/60%";
        }

        return "El punto de equilibrio no se ha cumplido: "+porcentaje+"%/60%";
    }
